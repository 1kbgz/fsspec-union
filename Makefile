...
lint-py:  ## lint python with ruff
	python -m ruff check fsspec_union
	python -m ruff format --check fsspec_union
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix fsspec_union
	python -m ruff format fsspec_union
...
test:  ## run python tests
	python -m pytest -v fsspec_union/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v fsspec_union/tests --cov=fsspec_union --cov-report term-missing --cov-report xml
